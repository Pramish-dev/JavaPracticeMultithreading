class thread implements Runnable {
 ...
 public class Test implements Runnable{
    ...
    public void run(){
        ...
        thread2.start();
        System.out.println("State of thread2 after calling .start() methode on it"+ thread2.getState());
        try{
            Thread.sleep(200);
        }
        catch(InterruptedException e){
        ...
        System.out.println("State of thread2 after calling .sleep() methode on it -"+ thread2.getState());
